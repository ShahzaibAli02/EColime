...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    fun getDummyData():List<Data>
    {
        ...
        listData.add(Data(latlng = "48.135517,11.571345", price = 0.41, isPrivate = true, name = "Rudy Haywood", avatar = "ic_avatar_1"))
        listData.add(Data(latlng = "48.139447,11.571926", price = 0.42, isPrivate = true, name = "Deidra Ayres", avatar = "ic_avatar_2"))
        listData.add(Data(latlng = "48.137085,11.584214", price = 0.40, isPrivate = true, name = "Chance Marlow", avatar = "ic_avatar_3"))
